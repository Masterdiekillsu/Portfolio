...
public class PvC
{
	...
	public void run()
	{
		System.out.println("This area is currently in development. Currently the game only supports 2 player play.");
		System.out.println("Sorry for the inconvenience, please go back to player selection.");
		System.out.println(" ");

...
public class Player2
{
	...
	public int [][] shipPlace()
	{
		...
		System.out.println("Player 2, please input your ship coordinates. Refer to the basic rules if need be by typing \"rules\"");
		...
		while (ACplace == true)
			{
				...
				if (Character.isAlphabetic(AC1.charAt(0)) && Character.isDigit(AC1.charAt(1))) {	
				...
				else
				{
					...
					if (Character.isAlphabetic(AC2.charAt(0)) && Character.isDigit(AC2.charAt(1))) {	
					...
					ACc2 -= 1;
					if (ACr2 >= Board2.length || -1 >= ACr2)
					{
						System.out.println("The board is a different size, go back and retype.");
						continue;
					}
					else if (ACc2 >= Board2.length || -1 >= ACc2)
					{
						System.out.println("The board is a different size, go back and retype.");
						continue;
					}
					if (ACr1 == ACr2 && ACc1 != ACc2)
					{
						...
						{
							Board2 [ACr1] [ACc1] = 5;
							Board2 [ACr1] [ACc1+1] = 5;
							Board2 [ACr1] [ACc1+2] = 5;
							Board2 [ACr1] [ACc1+3] = 5;
							Board2 [ACr2] [ACc2] = 5;
							ACplace = false;
						}
						else if (ACc2 == ACc1-4)
					...
					else if (ACr1 != ACr2 && ACc1 == ACc2)
					{
						...
						{
							Board2 [ACr1] [ACc1] = 5;
							Board2 [ACr1+1] [ACc1] = 5;
							Board2 [ACr1+2] [ACc1] = 5;
							Board2 [ACr1+3] [ACc1] = 5;
							Board2 [ACr2] [ACc2] = 5;
							ACplace = false;
						}
						else if (ACr2 == ACr1-4)
			...
			while (BSplace == true)
			{
				...
				if (Character.isAlphabetic(BS1.charAt(0)) && Character.isDigit(BS1.charAt(1))) {	
				...
				BSc1 -= 1;
				if (BSr1 >= Board2.length || -1 >= BSr1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (BSc1 >= Board2.length || -1 >= BSc1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				BSc2 -= 1;
				if (BSr2 >= Board2.length || -1 >= BSr2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (BSc2 >= Board2.length || -1 >= BSc2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				if (BSr1 == BSr2 && BSc1 != BSc2)
				{
					if (BSc2 == BSc1+3)
					{	
						if (Board2 [BSr1] [BSc1] != 0 || Board2 [BSr1] [BSc1+1] != 0 || Board2 [BSr1] [BSc1+2] != 0 || Board2 [BSr2] [BSc2] != 0)
						{
						...
						{
							Board2 [BSr1] [BSc1] = 4;
							Board2 [BSr1] [BSc1+1] = 4;
							Board2 [BSr1] [BSc1+2] = 4;
							Board2 [BSr2] [BSc2] = 4;
							BSplace = false;
						}
					}
				...
				else if (BSr1 != BSr2 && BSc1 == BSc2)
				{
					if (BSr2 == BSr1+3)
					{	
						if (Board2 [BSr1] [BSc1] != 0 || Board2 [BSr1+1] [BSc1] != 0 || Board2 [BSr1+2] [BSc1] != 0 || Board2 [BSr2] [BSc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
						{
							Board2 [BSr1] [BSc1] = 4;
							Board2 [BSr1+1] [BSc1] = 4;
							Board2 [BSr1+2] [BSc1] = 4;
							Board2 [BSr2] [BSc2] = 4;
							BSplace = false;
						}
					}
			...
			while (DESplace == true)
			{
				...
				DESc1 -= 1;
				if (DESr1 >= Board2.length || -1 >= DESr1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (DESc1 >= Board2.length || -1 >= DESc1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				DESc2 -= 1;
				if (DESr2 >= Board2.length || -1 >= DESr2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (DESc2 >= Board2.length || -1 >= DESc2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				if (DESr1 == DESr2 && DESc1 != DESc2)
				{
					if (DESc2 == DESc1+2)
					{	
						if (Board2 [DESr1] [DESc1] != 0 || Board2 [DESr1] [DESc1+1] != 0 || Board2 [DESr2] [DESc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
						{
							Board2 [DESr1] [DESc1] = 3;
							Board2 [DESr1] [DESc1+1] = 3;
							Board2 [DESr2] [DESc2] = 3;
							DESplace = false;
						}
					}
				...
				else if (DESr1 != DESr2 && DESc1 == DESc2)
				{
					if (DESr2 == DESr1+2)
					{	
						if (Board2 [DESr1] [DESc1] != 0 || Board2 [DESr1+1] [DESc1] != 0 || Board2 [DESr2] [DESc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
			...
			while (SUBplace == true)
			{
				...
				SUBc1 -= 1;
				if (SUBr1 >= Board2.length || -1 >= SUBr1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (SUBc1 >= Board2.length || -1 >= SUBc1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				SUBc2 -= 1;
				if (SUBr2 >= Board2.length || -1 >= SUBr2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (SUBc2 >= Board2.length || -1 >= SUBc2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				if (SUBr1 == SUBr2 && SUBc1 != SUBc2)
				{
					if (SUBc2 == SUBc1+2)
					{	
						if (Board2 [SUBr1] [SUBc1] != 0 || Board2 [SUBr1] [SUBc1+1] != 0 || Board2 [SUBr2] [SUBc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
						{
							Board2 [SUBr1] [SUBc1] = 1;
							Board2 [SUBr1] [SUBc1+1] = 1;
							Board2 [SUBr2] [SUBc2] = 1;
							SUBplace = false;
						}
					}
				...
				else if (SUBr1 != SUBr2 && SUBc1 == SUBc2)
				{
					if (SUBr2 == SUBr1+2)
					{	
						if (Board2 [SUBr1] [SUBc1] != 0 || Board2 [SUBr1+1] [SUBc1] != 0 || Board2 [SUBr2] [SUBc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
			...
			while (PTplace == true)
			{
				...
				PTc1 -= 1;
				if (PTr1 >= Board2.length || -1 >= PTr1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (PTc1 >= Board2.length || -1 >= PTc1)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				PTc2 -= 1;
				if (PTr2 >= Board2.length || -1 >= PTr2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				else if (PTc2 >= Board2.length || -1 >= PTc2)
				{
					System.out.println("The board is a different size, go back and retype.");
					continue;
				}
				...
				if (PTr1 == PTr2 && PTc1 != PTc2)
				{
					if (PTc2 == PTc1+1)
					{	
						if (Board2 [PTr1] [PTc1] != 0 || Board2 [PTr2] [PTc2] != 0)
						{
							System.out.println("Your ships are intersecting, that's not allowed. Please retype this ships coordinates.");
						}
						else
